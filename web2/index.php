...
<div class="col-lg-6 col-md-6 col-12">
<h2 class="display-4"> WELCOME TO GALAXY TOURISM</h2>
<p class="py-3">GALAXY TOURISM is an experienced travel management company. We work with you to manage all elements of your travel in an efficient, cost effective and ethical manner.At GALAXY TOURISM we are committed to providing a professional service to our customers, ensuring they benefit from our experience, unique style and  energy. A highly visible, independent and progressive travel agency, we aim to make a difference in everything we do.
</p>
...
<div class="card" >
  ...
  <div class="card-body">
    ...
    <p class="card-text">Cheapest hotal Booking Get Huge Discount </p>
    <a href="#" class="btn btn-primary">click here</a>
  </div>
